       ...
       String pw_entered=jPasswordField1.getText();
        ...
        try{String dpath="jdbc:mysql://localhost:3306/Router";
         Connection con = DriverManager.getConnection(dpath,"root","");
          ...
          ResultSet rst = st.executeQuery("SELECT * FROM owner WHERE User_name='" + username + "'");
          while (rst.next()) {
    String pw = rst.getString("Password");
    if(pw_entered.equals(pw))
            { JOptionPane.showMessageDialog(null, "Logged in");
            
            ownTab frontOwn=new ownTab();
            frontOwn.txt_welcomelink.setText(txt_UserName.getText());
             ImageIcon icon = new ImageIcon("E:/Project/yoo.png");
     frontOwn.setIconImage(icon.getImage());
            frontOwn.setVisible(true);
            dispose();
         }
...
con.close();
 ...
 SignupOwner signOwn=new SignupOwner();
 signOwn.setVisible(true);
 dispose();
