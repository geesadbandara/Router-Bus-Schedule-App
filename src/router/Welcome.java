...
public class Welcome extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        LoginOwner logOwn=new LoginOwner();
     logOwn.setVisible(true);
     ImageIcon icon = new ImageIcon("E:/Project/yoo.png");
     logOwn.setIconImage(icon.getImage());
     dispose();
     
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
Login logCus=new Login();
logCus.setVisible(true);
ImageIcon icon = new ImageIcon("E:/Project/yoo.png");
     logCus.setIconImage(icon.getImage());
